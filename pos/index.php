            ...
            <div class="row table-list">
                <div class="col-md table-list-content">
                    <ul>
                        ...
                        <li <?php if($rowtable['Status']==1){echo 'class="tb-active"';}?>
                            id="<?php echo $rowtable['IdTable']; ?>"
                            onclick="cms_load_pos(<?php echo $rowtable['IdTable'];?>)">
                            <?php echo $rowtable['TableName']; ?></li>
                        <?php }
							?>
                    </ul>
                </div>
            ...
            <div class="row product-list">
                <div class="col-md product-list-content">
                    <ul>
                        ...
                        <li><a href="#" onclick="cms_select_menu('<?php echo $rowmenu['IdMenu'];?>')"
                                title="<?php echo $rowmenu['NameMenu'];?>">
                ...
                <div class="col-md-5">
                    <div class="col-md-12 p-0 input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#ModelAddcustomer"><i
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 p-1">
                            <textarea class="form-control" id="note-order" placeholder="Nhập ghi chú hóa đơn"
                                rows="3"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-xs-6 p-1">
                            <button type="button" class="btn-print" onclick="cms_save_table()"><i
                                    class="fa fa-credit-card" aria-hidden="true"></i> Thanh Toán (F9)</button>
                        </div>
                        <div class="col-md-6 col-xs-6 p-1">
                            <button type="button" class="btn-pay" onclick="cms_save_oder()"><i class="fa fa-floppy-o"
                                    aria-hidden="true"></i> Lưu (F10)</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control customer-pay" value="0"
                                placeholder="Nhập số điền khách đưa">
                        </div>
                    </div>
                    <div class="row form-group">
...
<div class="modal fade" id="ModelAddcustomer" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
